...
import { applyTranslationWorkspaceContentUpdate } from "@/lib/payload/translations-workspace.ts";
...
export async function PATCH(
  ...
  try {
    ...
    await applyTranslationWorkspaceContentUpdate(req.payload, req, translationId, body);
    ...
    return createAdminApiErrorResponse(error, req, {
      default: "Unable to update translation content.",
      forbidden: "Forbidden.",
      noOp: "No translation content changes were submitted.",
